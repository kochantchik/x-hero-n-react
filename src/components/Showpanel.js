...
export default function Showpanel(props) {
  ...
  return (
    <div className={style.maincontainer}>
      ...
      <div className={style.columnBlockLeft}> 
      ...
      <div className={style.columnBlockCenter}>
        <div className={style.columns}>
          <p>Характеристики</p>
          <div className={style.lines}>
            <div className={style.columnsText}>
              <p className={props.mainStat === "str" ? style.mainStat : style.stat} onClick={props.click}>STR</p>
              <p>{props.item.str ? props.item.str : <br/>}</p>
            </div>
            <div className={style.columnsText}>
              <p className={props.mainStat === "agi" ? style.mainStat : style.stat} onClick={props.click}>AGI</p>
             <p>{props.item.agi ? props.item.agi : <br/>}</p>
            </div>
            <div className={style.columnsText}>
              <p className={props.mainStat === "int" ? style.mainStat : style.stat} onClick={props.click}>INT</p>
              <p>{props.item.int ? props.item.int : <br/>}</p>
            </div>
          </div>
        </div>
        <div className={style.columns}>
          <p className={style.textCenter}>Второстепенные Характеристики</p>
            <div className={style.columns}>
              ...
              <div className={props.item.as ? style.linesTextCH : style.linesTextCH + " " + style.inactive}>
                <p>Скорость Атаки</p>
                <p>{props.item.as}</p>
              </div>
              ...
              <div className={props.item.ms ? style.linesTextCH : style.linesTextCH + " " + style.inactive}>
                <p>Скорость</p>
                <p>{props.item.ms}</p>
              </div>
          </div>
      ...
      <div className={style.columnBlockRight}>
        <div className={style.columnsText}>
        ...
        <div className={style.columns}>
          <p className={props.item.act || props.item.pas ? "" : style.inactive}>Эффекты</p>
        ...
        <div className={props.item.comp[0] !== undefined ? style.columnsText : style.columnsText + " " + style.inactive}>
          <p>Компоненты</p>
          <div className={style.columns}>
            <div className={style.lines}>
              <div className={style.lines}>
